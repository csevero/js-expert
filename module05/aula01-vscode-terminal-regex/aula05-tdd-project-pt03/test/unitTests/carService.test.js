...
describe('CarService Suite Test', () => {
  ...
  it('given a carCategory, customer and numberOfDays it should calculate final amount in real', async () => {
    ...
    //when somebody get the taxesBaseOnAge function, we always return the mocked values, to check te change you can add a console.log to check function return
    sandbox
